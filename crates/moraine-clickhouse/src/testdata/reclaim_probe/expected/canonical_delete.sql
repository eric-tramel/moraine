...
WHERE source_host = 'h' AND source_name = 'codex' AND doc_id IN (SELECT event_uid FROM `moraine`.search_documents WHERE (source_host, source_name, source_file, source_generation) IN (('h', 'codex', '/live.jsonl', toUInt32(5))));
...
WHERE (source_host, source_name, event_uid) IN (SELECT source_host, source_name, event_uid FROM `moraine`.events WHERE (source_host, source_name, source_file, source_generation) IN (('h', 'codex', '/live.jsonl', toUInt32(5))));
