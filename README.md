...
harnesses such as Codex, Claude Code, Kiro CLI, Kimi CLI, OpenCode, Hermes, and
...
register Moraine MCP for supported harnesses such as OpenCode, Cursor, Kimi CLI,
and Pi Coding Agent. The integrations use the `moraine` CLI on your `PATH` and
